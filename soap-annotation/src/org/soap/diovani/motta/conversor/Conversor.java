 ...
 * Data: 09/05/2015
 * Classe responsável por efetuar a conversão dos valores lidos do web service
 */
public class Conversor {

	/**
	 * Método responsável por efetuar a conversao de um objeto do tipo Object em String
	...
	/**
	 * Método responsável por efetuar a conversao de um objeto do tipo Object em Integer
	 * @param object o objeto a ser convertido
	...
	/**
	 * Método responsável por efetuar a conversao de um objeto do tipo Object em BigDecimal
	 * @param object o objeto a ser convertido
	...
	/**
	 * Método responsável por efetuar a conversao de um objeto do tipo Object em Date
	 * @param object o objeto a ser convertido
	...
	public static Date toDate(Object object) throws Exception{
		if(!(object instanceof Date)){
			throw new ClassCastException("Não foi possível converter o parâmetro em java.util.Date");
		}
		Date date = (Date) object;
		return DateConvert.toDate(date);
	}
	
	/**
	 * Método responsável por efetuar a conversao de um objeto do tipo Object em Boolean
	 * @param object o objeto a ser convertido
	...
	/**
	 * Método responsável por efetuar a conversao de um objeto do tipo Object em Long
	 * @param object o objeto a ser convertido
	...
	/**
	 * Método responsável por efetuar a conversao de um objeto do tipo Object em Float
	 * @param object o objeto a ser convertido
	...
	/**
	 * Método responsável por efetuar a conversao de um objeto do tipo Object em Double
	 * @param object o objeto a ser convertido
