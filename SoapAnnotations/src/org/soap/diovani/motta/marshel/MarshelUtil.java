...
public class MarshelUtil implements Marshal {
	...
	/**
	 * Método responsável por adicionar e registrar o envelope que será enviado para o servidor
	...
	/**
	 * Método responsável por registrar os atributos de um objeto do tipo complexo dentro do envelope que será enviado 
	 * @param envelope o objeto que será enviado para o servidor
	 * @param classAnnotations as anotações contidas na classe
	 */
