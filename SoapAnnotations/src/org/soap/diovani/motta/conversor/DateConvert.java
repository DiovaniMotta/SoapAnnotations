 ...
 * Data: 11/05/2015.
 * Classe responsável por efetuar a conversão de um objeto em String 
 */
public class DateConvert {
	...
	/**
	 * Método responsável por converter um objeto, que  será convertido para Date em uma String.
